...
namespace Aron.GrassMiner.Services
{
    public class VPNClientService
    {
        ...
        private readonly string accountName = "ncku";
        private string vpnHost = null;
        public async Task Start()
        {
            try
            {
                ...
                await vpnClient.AccountImport("ncku.vpn");

                vpnHost = (await vpnClient.AccountGet(accountName)).DestinationVPNServerHostName;
